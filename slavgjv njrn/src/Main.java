...
public class Main {
    ...
    private static final String NOME_PASTA = "Bancodedado";
    private static final String NOME_ARQUIVO = "arquivo.txt";
    private static final String CAMINHO_COMPLETO = NOME_PASTA + File.separator + NOME_ARQUIVO;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("╔══════════════════════════════════════╗");
        System.out.println("║       EDITOR DE ARQUIVO - Java       ║");
        System.out.println("║ Arquivo fixo: Bancodedado/arquivo.txt║");
        System.out.println("╚══════════════════════════════════════╝");
    ...
    private static void criarArquivo() {
        ...
        if (arquivo.exists()) {
            System.out.println("[!] O arquivo '" + CAMINHO_COMPLETO + "' JA EXISTE.");
        ...
        try {
            if (arquivo.createNewFile()) {
                System.out.println("[✓] Arquivo criado com sucesso em: " + CAMINHO_COMPLETO);
            }
        } catch (IOException e) {
    ...
    private static void modificarArquivo(Scanner scanner) {
        ...
        if (!arquivo.exists()) {
            System.out.println("[!] O arquivo '" + CAMINHO_COMPLETO + "' NAO EXISTE.");
            System.out.println("    Use a opcao 1 para criar o arquivo primeiro.");
            return;
        }

        System.out.print("Digite o conteudo a adicionar: ");
    ...
    private static void excluirArquivo() {
        ...
        System.out.print("[!] Tem certeza que deseja excluir '" + CAMINHO_COMPLETO + "'? (s/n): ");
